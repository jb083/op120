...
\usepackage[unicode,pdfusetitle]{hyperref} %ハイパーリンク
...
% 文書データ
\usepackage{tex/jbtitle}
\title{ブラームス: 2つのクラリネットソナタ 作品120}
\subtitle{Zwei Sonaten für Klarinette und Klavier}
\opus{120}
\author{H.~S.}
\date{2017.06.19-}
...
% \input{./tex/0-preface.tex}

\input{./tex/1-history.tex}
